...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="ShowUser">		
		...
		<table>
			...
			<xsl:if test="UsernameFieldMode != 'DISABLED' and user/Attributes/Attribute[Name = 'username']">
				<tr>
			...
			<xsl:if test="EmailFieldMode != 'DISABLED' and user/Attributes/Attribute[Name = 'email']">
				<tr>
	...
	<xsl:template name="EditUser">
		...
		<table>
			...
			<xsl:if test="UsernameFieldMode != 'DISABLED'">
				<tr>
					<td><xsl:value-of select="$i18n.username"/>:</td>
					<td>
			...
			<xsl:if test="PasswordFieldMode != 'DISABLED'">
			...
			<xsl:if test="EmailFieldMode != 'DISABLED'">				
				<tr>
					<td><xsl:value-of select="$i18n.emailAddress"/>:</td>
					<td>
						<xsl:call-template name="createTextField">
