...
@Table(name = "text_field2_queries")
@XMLElement
public class TextField2Query extends BaseQuery {

	private static final long serialVersionUID = -842191226937409416L;

	public static final Field TEXT_FIELDS_RELATION = ReflectionUtils.getField(TextField2Query.class, "fields");
	...
	private List<TextField2> fields;

	@DAOManaged(dontUpdateIfNull=true)
	@OneToMany(autoUpdate=true)
	@XMLElement
	private List<TextField2QueryInstance> instances;
	...
	public List<TextField2> getFields() {

		return fields;
	}

	public List<TextField2QueryInstance> getInstances() {

		return instances;
	}

	public void setInstances(List<TextField2QueryInstance> instances) {
	...
	public void setFields(List<TextField2> alternatives) {
	...
	public void toXSD(Document doc) {
		...
		for(TextField2 textField : fields){
	...
	private String generateElementName(TextField2 textField, ArrayList<String> fieldElementNames) {
	...
	public void populate(XMLParser xmlParser) throws ValidationException {
		...
		layout = XMLValidationUtils.validateParameter("layout", xmlParser, true, TextField2CRUD.LAYOUT_POPULATOR, errors);
		
		List<XMLParser> xmlParsers = xmlParser.getNodes("Fields/TextField");
		
		if(xmlParsers != null) {
			
			fields = new ArrayList<TextField2>();
