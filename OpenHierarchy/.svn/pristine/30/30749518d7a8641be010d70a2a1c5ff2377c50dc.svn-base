...
public interface CoreDaoFactory {
	...
	public ModuleAttributeDAO<SimpleForegroundModuleDescriptor> getForegroundModuleAttributeDAO();

	public ModuleAttributeDAO<SimpleBackgroundModuleDescriptor> getBackgroundModuleAttributeDAO();

	public ModuleAttributeDAO<SimpleFilterModuleDescriptor> getFilterModuleAttributeDAO();
}
