...
Ext.define('MapClient.Gui', {
	...
	constructor : function(config) {
		...
		if (this.gui.map && this.gui.map.renderTo) {
			var element = Ext.get(this.gui.map.renderTo);
...
Ext.define('MapClient', {
	 ...
	 *
	 *     mapClient.drawLayer.styleMap = new OpenLayers.StyleMap(style);
     * 
     * See http://docs.openlayers.org/library/feature_styling.html for more examples.
     * 
     ...
     * @param {Object} options.gui options to control GUI elements
     */
...
Ext.define('MapClient.config.Parser', {
	...
	parse : function(config) {
		...
		options.layers = config.layers.map(this.createLayer);
