...
Ext.define('OpenEMap.view.ObjectConfig', {
    ...
    initComponent : function() {
        ...
        var types = {
            ...
            hidden: true,
            items : [ {
                boxLabel : '<img src="'+ OpenEMap.Client.basePathImages +'figur-R.png">',
                name : 'rb',
                inputValue : 'R',
                checked : true
            }, {
                boxLabel : '<img src="'+ OpenEMap.Client.basePathImages +'figur-L.png">',
                name : 'rb',
                enabled: false,
                inputValue : 'L'
            }, {
                boxLabel : '<img src="'+ OpenEMap.Client.basePathImages +'figur-D.png">',
                name : 'rb',
                enabled: false,
                inputValue : 'D'
            }, {
                boxLabel : '<img src="'+ OpenEMap.Client.basePathImages +'figur-O.png">',
                name : 'rb',
                enabled: false,
                inputValue : 'O'
            } ],
    ...
    updateHelpImage: function(type) {
        ...
        this.down('#objectimage').update('<img src="' + OpenEMap.Client.basePathImages + name + '"></img>');
    }
});
/**
...
Ext.define('OpenEMap.form.SearchRegisterenhet', {
    ...
    initComponent : function() {
        ...
        function doSearch(id) {
            ...
            Ext.Ajax.request({
                url: OpenEMap.Client.basePathLM + 'registerenheter/'+id+'/enhetsomraden',
        ...
        this.store = Ext.create('Ext.data.Store', {
            proxy: {
                type: 'ajax',
                url : OpenEMap.Client.basePathLM + 'registerenheter',
                reader: {
                    type: 'json',
                    root: 'features'
                }
...
Ext.define('OpenEMap.form.SearchAddress', {
    ...
    initComponent : function() {
        ...
        function doSearch(fnr, x, y) {
            ...
            this.mapPanel.searchLayer.destroyFeatures();
            Ext.Ajax.request({
                url: OpenEMap.Client.basePathLM + 'registerenheter?fnr=' + fnr,
                success: function(response) {
        ...
        this.store = Ext.create('Ext.data.Store', {
            proxy: {
                type: 'ajax',
                url : OpenEMap.Client.basePathLM + 'addresses',
                reader: {
                    type: 'array'
                }
            },
...
Ext.define('OpenEMap.form.SearchPlacename', {
    ...
    initComponent : function() {
        ...
        this.store = Ext.create('Ext.data.Store', {
            proxy: {
                type: 'ajax',
                url : OpenEMap.Client.basePathLM + 'placenames',
                reader: {
                    type: 'json',
                    root: 'features'
                },
    ...
    constructor: function(config) {
        ...
        var Click = OpenLayers.Class(OpenLayers.Control, {
            ...
            onClick: function(evt) {
                ...
                Ext.Ajax.request({
                    url: OpenEMap.Client.basePathLM + 'registerenheter?x=' + x + '&y=' + y,
                    success: function(response) {
...
Ext.define('OpenEMap.view.layer.Advanced' ,{
	...
	height: 650,
 	...
 	initComponent: function() {	
 		...
 		var abstract_ws_url = 'openemapadmin/geometadata/getabstractbyid/';	
 		var metadata_ws_url = 'openemapadmin/geometadata/getmetadatabyid/';
